...
class Product with ChangeNotifier {
  ...
  Future<void> isProductFavorite(String token, String userId) async{
    final oldStatus = isFavorite;
    isFavorite = !isFavorite;
    notifyListeners();
    final url = "https://shopping-app-flutter-36ebb.firebaseio.com/userFavorites/$userId/$id.json?auth=$token";
    try{
