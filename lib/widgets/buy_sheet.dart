...
class BuySheetState extends State<BuySheet> {
  ...
  void initState(){
    ...
    WidgetsBinding.instance
        .addPostFrameCallback((_) => _showOrderSheet);
  }
      ...
      body: Builder(
        builder: (context) => Center(
            child: Column(
              ...
              children: [
//                Container(
//                  child: Image(image: AssetImage('assets/images/iconCookie.png')),
//                ),
                Center(
                  child: Container(
                    child: Text(
                ...
                Container(
                  child: Text(
                    "Please select an electronic payment system",
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 16,
                    ),
                ...
                Container(
                  ...
                  child:
                  CookieButton(text: "Payment option", onPressed: _showOrderSheet),
                ),
                SizedBox(height: 50,),
                Container(
